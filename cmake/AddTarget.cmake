...
function(CollectSources target_modules)
  ...
  foreach(mod ${target_modules})
    ...
    foreach(header IN LISTS module_headers)
      list(APPEND cpp_headers "${mod}/include/zamt/${mod}/${header}")
    endforeach()
    list(APPEND all_cpp_headers ${cpp_headers})
    ...
    list(APPEND include_directories "${mod}/include/zamt/${mod}")
  endforeach(mod)
  set(include_directories ${include_directories} PARENT_SCOPE)
  set(collected_sources ${all_cpp_headers} ${all_cpp_sources} PARENT_SCOPE)
